...
vignette: >
  %\VignetteIndexEntry{Appendix: Clean OSCN Charge Descriptions}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

```{r setup, message=FALSE, echo=FALSE, warning=FALSE, eval=FALSE}
library(ojodb)
library(ojoregex)
library(gt)
...
```{r big_table, message=FALSE, echo=FALSE, warning=FALSE, eval=FALSE}
