...
#'   \item{category}{Description of category}
#'   \item{subcategory}{Description of subcategory}
#'   \item{title}{Description of title}
#'   \item{statutes}{Description of statutes}
#'   \item{chapter}{Description of chapter}
#'   \item{gist}{Description of gist}
#'   \item{description}{Description of description}
